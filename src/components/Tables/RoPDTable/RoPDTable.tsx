...
import { PlayerDetailModel as PlayersModel } from "@/models/ropd/ropd-players";
import { PlayerDetailModel as PlayersByIdModel } from "@/models/ropd/ropd-id";
...
const RoPDTable = ({
    ...
    title: string;
    data: PlayersModel[] | PlayersByIdModel[] | undefined;
}) => {
