...
import { ListingModel } from "@/models/history/item-history";
                        ...
                        {data !== undefined && data.items && data.items.length > 0 ? (
                            data.items.map((row, idx) => (
                                <TableRow hover key={`item-row-${row.itemId}-${idx}`}>
                                    ...
                                    <TableCell
                                        key={`item-row-min-price-${row.itemId}-${idx}`}
                                        sx={{ color: COLORS.third_background_text }}
                                        align="center"
                                    >
                                        <CustomTypography variant="body2" component="div">
                                    ...
                                    >
                                        ...
                                        >
                                            <Box display="flex" flexDirection="row" alignItems="center" justifyContent="center">
                                                ...
                                                <FormatPercentColor
                                                    value={saleKind === 'vending' ? row.avgSellPriceGrowth : row.avgBuyPriceGrowth}
                                                    type={saleKind}
                                                />
                                            </Box>
                                        </ItemTooptip>
                                    ...
                                    <TableCell
                                        key={`item-row-max-price-${row.itemId}-${idx}`}
                                        sx={{ color: COLORS.third_background_text }}
                                        align="center"
                                    >
                                        <CustomTypography variant="body2" component="div">
