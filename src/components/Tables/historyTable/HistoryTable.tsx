...
import { ItemListingModel } from "@/models/history/item-detail";
                                    ...
                                    <TableRow hover key={`item-row-${row.itemId}-${idx}`}>
                                        ...
                                        >
                                            <ItemTooptip
                                                ...
                                                data={row}
                                                type={title === 'Vending History' ? 'vending' : 'buying'}
                                            >
                                                <Box display="flex" flexDirection="row" alignItems="center" justifyContent="center">
                                                    ...
                                                    <FormatPercentColor
                                                        value={title === 'Vending History' ? row.averageSellPercent : row.averageBuyPercent}
                                                        type={title === 'Vending History' ? 'vending' : 'buying'}
                                                    />
                                                </Box>
                                            </ItemTooptip>
                                        ...
                                        <TableCell
                                            key={`item-row-date-${row.itemId}-${idx}`}
                                            sx={{ color: COLORS.third_background_text }}
                                            align="center"
                                        >
                                            <CustomTypography variant="body2" component="div">
