import { ListingSummaryResponse } from "@/services/global/listing-summary";
...
export interface ListingSummaryModel {
    buying: ItemListingModel[];
    selling: ItemListingModel[];
};

const ListingSummaryToModel = (data: ListingSummaryResponse): ListingSummaryModel => {
...
export default ListingSummaryToModel;
